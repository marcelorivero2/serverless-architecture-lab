...
namespace TollBooth
{
    public class SendToEventGrid
    {
        ...
        private async Task Send(string eventType, string subject, LicensePlateData data)
        {
            ...
            _log.LogInformation("Event Grid Topic: " + Environment.GetEnvironmentVariable("eventGridTopicEndpoint"));
            _log.LogInformation("Event Grid Topic Key: " + Environment.GetEnvironmentVariable("eventGridTopicKey"));
            _log.LogInformation("Tipo Evento:" + eventType);
