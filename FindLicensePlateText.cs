...
namespace TollBooth
{
    public class FindLicensePlateText
    {
        ...
        private async Task<string> MakeOCRRequest(byte[] imageBytes)
        {
            ...
            _log.LogInformation("VISION URL:" + Environment.GetEnvironmentVariable("computerVisionApiUrl"));
            _log.LogInformation("VISION KEY:" + Environment.GetEnvironmentVariable("computerVisionApiKey"));
